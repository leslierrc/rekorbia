export const es = {
  ...
  pricing: {
    ...
    title: 'Vendemos tiempo, no software.',
    subtitle: 'Elige el plan que mejor se adapte a tu operación. Todos incluyen IA.',
    monthly: '/mes',
    annual: '/año',
    ...
    plans: [
      {
        name: 'Starter',
        price: '49',
        description: 'Para brokers independientes empezando a escalar más allá de Excel.',
        features: [
      ...
      },
      {
        name: 'Pro',
        price: '149',
        description: 'Para equipos pequeños que ya manejan volumen constante.',
        features: [
          'Todo lo de Starter',
          'Hasta 5 usuarios',
      ...
      },
      {
        name: 'Business',
        price: '299',
        description: 'Para brokerages en crecimiento con múltiples agentes.',
        features: [
          'Todo lo de Pro',
          'Usuarios ilimitados',
          'API e integraciones',
    ...
    futureTitle: 'Ingresos futuros adicionales',
    futureDescription: 'Facturas adelantadas (factoring), seguros de carga, marketplace de servicios y acceso vía API.',
  },
  cta: {
