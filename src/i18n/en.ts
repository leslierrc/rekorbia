export const en = {
  ...
  pricing: {
    ...
    subtitle: 'Choose the plan that best fits your operation. All include AI.',
    monthly: '/mo',
    annual: '/yr',
    annualSave: 'Save 20%',
    cta: 'Get started',
    ...
    plans: [
      {
        name: 'Starter',
        price: '49',
        description: 'For independent brokers starting to scale beyond Excel.',
        features: [
      ...
      },
      {
        name: 'Pro',
        price: '149',
        description: 'For small teams handling constant volume.',
        features: [
      ...
      },
      {
        name: 'Business',
        price: '299',
        description: 'For growing brokerages with multiple agents.',
        features: [
          'Everything in Pro',
          'Unlimited users',
          'API & integrations',
    ...
    futureTitle: 'Additional future revenue',
    futureDescription: 'Invoice factoring, cargo insurance, services marketplace, and API access.',
  },
  cta: {
